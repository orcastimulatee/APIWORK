...
|| $INDEX1 || NOCHMAL2A || SCHICKEN2^* || BITTE1A || DU1^* || FERNSEHER1B* || SCHAUEN1 || ICH1 || OKAY1A**________________________________________
Output:
entity 1: the speaker A
•	DU1^*(in indirect speech said by someone else(B) :B's “you” means “speaker A”)
•	ICH1(This is speaker A speaking, therefore 'I' means speaker A)
entity 3: ‘SMS/Nachricht’ (the message)
•	SCHICKEN2^*
entity 4: ‘Fernseher’(TV)
•	FERNSEHER1B*

"""

user_prompt = prompt_12
